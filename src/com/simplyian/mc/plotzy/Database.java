...
public class Database {
    ...
    public static void initCfg(){
        ...
        if(!config_file.exists()){
            ...
            try {
                ...
                pl.getLog().info("[Plotzy] Error creating the config file. >:-O");
            }
        } else {
            pl.getLog().info("[Plotzy] Configuration loaded."); //Load the configuration file
        }
    }
    ...
    public static void connect() {
        ...
        try {
            ...
            pl.getLog().info("[Plotzy] Connected to database!");
        } catch (SQLException ex) { //Error handling below:
            pl.getLog().info("[Plotzy] An error occured while connecting to the database. Perhaps your database info is incorrect?");
            sqlErrors(ex);
        }
    }
    ...
    public static void close() {
        try {
            ...
            pl.getLog().info("[Plotzy] An error occured while closing the connection.");
            sqlErrors(ex);
        }
    }
    ...
    public static void sqlErrors(SQLException ex) {
        pl.getLog().info("[Plotzy] SQLException: " + ex.getMessage());
        pl.getLog().info("[Plotzy] SQLState: " + ex.getSQLState());
        pl.getLog().info("[Plotzy] VendorError: " + ex.getErrorCode());
    }
